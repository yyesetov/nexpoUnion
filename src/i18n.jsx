...
const I18N = {
  ru: {
    ...
    fee_tip_body: 'Деньги идут на поддержание мангала: покупку нового инвентаря, чистящих щёток, скребков и моющего средства. Оплата — Kaspi на +7 777 110 0329.',
    ...
    footer_support: 'Поддержка: +7 777 110 0329',
  },
  kz: {
    ...
    fee_tip_body: 'Ақша мангалды күтіп-ұстауға жұмсалады: жаңа құрал-саймандар, щёткалар, скребоктар және жуғыш құрал сатып алу. Төлем — Kaspi: +7 777 110 0329.',
    submit: 'Брондау',
    ...
    footer_support: 'Қолдау: +7 777 110 0329',
  },
};
